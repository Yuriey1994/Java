                ...
                switch (event.getButton()) {
                    case PRIMARY:
                        ...
                        if (target == easyModePane) {
                            ...
                            SceneManager.getInstance().changeNodeOfContainer(GlobalConfig.FXML_CUSTOM, null);
                        }
                        SceneManager.getInstance().changeNodeOfContainer(GlobalConfig.FXML_GAME, new GameModeSetMessage(mode));
                        break;
                    default:
                        break;
                }
